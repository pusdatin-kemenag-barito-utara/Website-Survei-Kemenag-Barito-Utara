    ...
    async function fetchData() {
      ...
      try {
        ...
        const [pubResults, svcData, activePeriodResp, settingsData] = await Promise.all([
          apiFetch<PublicResultsResponse>('/survey/public-results').catch(() => null),
          apiFetch<Service[]>('/survey/services').catch(() => []),
        ...
        if (pubResults) {
          ...
          if (pubResults.demographic_summary) setDemoSummary(pubResults.demographic_summary)
        }
