          ...
          {['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'].map((d, index) => (
            <span
              ...
              className={cn(
                ...
                index === 0 ? 'text-rose-600 dark:text-rose-400 font-extrabold' : 'text-slate-400'
              )}
            >
              {d}
            </span>
          ...
          {Array.from({ length: daysInMonth }).map((_, i) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'h-8 w-8 rounded-xl text-xs font-bold transition-all flex items-center justify-center cursor-pointer',
                  isSelected
                    ? isSunday
                    ...
                    : isToday
                    ? isSunday
                      ? 'border-2 border-rose-500 text-rose-600 font-black bg-rose-50/50 dark:bg-rose-950/30'
                      : 'border-2 border-emerald-500 text-emerald-600 font-black'
                    : isSunday
                    ? 'text-rose-600 dark:text-rose-400 font-extrabold hover:bg-rose-50 dark:hover:bg-rose-950/40'
