            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
              <Link href={SURVEY_ROUTES.HOME} className="flex items-center" onClick={() => setOpen(false)}>
                <div className="flex h-10 items-center justify-center">
                  <Image src="/arus.webp" alt="ARUS Logo" width={100} height={50} className="h-9 w-auto max-h-9 max-w-[120px] object-contain" />
                </div>
              </Link>
              <button
                onClick={() => setOpen(false)}
            ...
            <div className="px-4 py-4 border-t border-gray-100 space-y-4">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    onClick={() => { setLocale('id'); Analytics.switchLanguage('id'); setOpen(false) }}
                    className={cn(
                  ...
                  <button
                    onClick={() => { setLocale('en'); Analytics.switchLanguage('en'); setOpen(false) }}
                    className={cn(
                      "flex items-center justify-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 border cursor-pointer",
