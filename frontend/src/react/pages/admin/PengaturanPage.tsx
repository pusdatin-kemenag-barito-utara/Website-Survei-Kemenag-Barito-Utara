              ...
              <CardContent className="p-6 space-y-5">
                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <Input id="turnstile_site_key" placeholder="0x4AAAAAA..." {...register('turnstile_site_key')} className="rounded-xl border-slate-200 text-xs" />
                  </div>

                  <div className="space-y-1.5">
                    <Label htmlFor="turnstile_secret_key" className="text-xs font-bold text-slate-700">Turnstile Secret Key</Label>
                    <Input id="turnstile_secret_key" type="password" placeholder="••••••••••••••••" {...register('turnstile_secret_key')} className="rounded-xl border-slate-200 text-xs" />
                  </div>
                </div>
              </CardContent>
            </Card>
